export function initMember_myAcnt() {
  console.log("Initializing member account...");
  ...
  // Fetch Profile Data
  fetch("http://localhost:8080/Group_Project_48/backend/api/controllers/memberController.php?action=get_profile", requestOptions)
    .then((res) => {
  ...
  document.getElementById("update-profile-btn").addEventListener("click", () => {
    ...
    fetch("http://localhost:8080/Group_Project_48/backend/api/controllers/memberController.php?action=update_profile", updateOptions)
      .then((res) => {

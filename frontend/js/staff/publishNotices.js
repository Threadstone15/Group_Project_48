export function initStaff_publishNotice() {
    ...
    window.deleteNotice = function (noticeId) {
        ...
        document.getElementById("confirmDelete").onclick = () => {
            ...
            fetch(`http://localhost:8080/Group_Project_48/backend/api/controllers/staffController.php?action=delete_notice&notice_id=${noticeId}`, {
                method: 'DELETE',
                headers: {
    ...
    document.getElementById("updateForm").addEventListener("submit", function (event) {
        ...
        fetch("http://localhost:8080/Group_Project_48/backend/api/controllers/staffController.php?action=update_notice", {
            method: 'PUT',
            headers: {
                'Authorization': `Bearer ${authToken}`,
                'Content-Type': 'application/json'
